<template>
    <div class="w-full px-6">
        ...
        <div v-if="tabVal === '2'" class="w-full flex flex-wrap mt-5">
            <div class="flex" v-for="(item, index) in projectInfo.cell_volt_info" :key="index">
                <div class="flex flex-col">
                    <div
                        class="bg-[#F6F7FC] text-[#666666] min-w-[100px] h-10 flex items-center justify-center text-[14px]">
                        序号</div>
